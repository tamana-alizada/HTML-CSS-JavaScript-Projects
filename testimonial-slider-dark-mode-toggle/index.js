...
function updateBody() {
  ...
  if (inputEl.checked === true) {
    ...
    testimonialEl.style.boxShadow = '0 0 8px rgba(255, 255, 255, 0.8)';
    imgEl.style.boxShadow = '0 0 8px rgba(255, 255, 255, 0.8)';
  } else {
    bodyEl.style.background = 'white';
    testimonialEl.style.background = 'black';
    textEl.style.color = 'white';
    usernmaeEl.style.color = 'white';
    testimonialEl.style.boxShadow = '0 0 8px rgba(0, 0, 0, 0.8)';
    imgEl.style.boxShadow = '0 0 8px rgba(0, 0, 0, 0.8)';
  }
  localStorageSave();
}
